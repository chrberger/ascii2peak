...
```
docker run --init --rm --privileged --net=host registry.git.chalmers.se/chalmers-revere/opendlv-device-gps-peak:v2.0.0 --can=can0 --cid=111 --verbose
```
...
services:    # Must be present exactly once at the beginning of the docker-compose.yml file
    dev-gps-nmea:
        ...
        image: registry.git.chalmers.se/chalmers-revere/opendlv-device-gps-peak:v2.0.0
        privileged: true
        restart: on-failure
        network_mode: "host"
